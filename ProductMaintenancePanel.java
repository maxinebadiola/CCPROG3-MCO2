 ...
 * @author ERICA
 */
public class ProductMaintenancePanel extends javax.swing.JPanel {
    private Machine machine;
    private ProductPanel productsPanel;
    private PrintProductPanel printProductPanel;



    public ProductMaintenancePanel(Machine machine) {
       this.machine = machine;
       initComponents();
       initializeProductsPanel(machine);
       initializePrintProductPanel(machine);
    }
    ...
    private void initComponents() {
        ...
        restockSlotButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                restockSlotButtonActionPerformed(evt);
            }
        });
        ...
        restockAllSlotsButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                restockAllSlotsButtonActionPerformed(evt);
            }
        });
        ...
        restockSlotInput.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                restockSlotInputActionPerformed(evt);
            }
        });
        ...
        confirmButton2.setBackground(new java.awt.Color(153, 209, 153));
        confirmButton2.setFont(new java.awt.Font("Agency FB", 1, 21)); // NOI18N
        confirmButton2.setForeground(new java.awt.Color(255, 255, 255));
        confirmButton2.setText("Confirm");
        confirmButton2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 255), 5, true));
                ...
                .addGroup(restockAllSlotsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, restockAllSlotsPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(restockAllSlotsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            ...
                            .addComponent(confirmButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(90, 90, 90)
                ...
                .addGroup(restockAllSlotsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(restockAllSlotsPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(restockAllSlotsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel2))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(confirmButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void restockAllSlotsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restockAllSlotsButtonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_restockAllSlotsButtonActionPerformed

    private void restockSlotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restockSlotButtonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_restockSlotButtonActionPerformed

    private void exitButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitButton2ActionPerformed
          mainJFrame frame = (mainJFrame) javax.swing.SwingUtilities.getWindowAncestor(this);
        ProductMaintenancePanel productMaintenancePanel = new ProductMaintenancePanel(machine);
    ...
    ProductPanel productsPanel = (ProductPanel) container1.getComponent(0);
    ...
    if (selectedProduct != null) {
           ...
           int inputAmount = Integer.parseInt(userInput);
            ...
            if (selectedProduct != null && inputAmount > 0) {
                performRestock(selectedProduct, inputAmount);
            } else {
                JOptionPane.showMessageDialog(this, "Please select a product and enter a valid restock amount.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
            }
    } else {
    ...
    private void restockSlotInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restockSlotInputActionPerformed
    
    }//GEN-LAST:event_restockSlotInputActionPerformed
    ...
    if (userInput != null) {
           ...
           int inputAmount = Integer.parseInt(userInput);
            ...
            if (machine.validRestockAll(inputAmount)) {
    ...
    private void restockAllInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restockAllInputActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_restockAllInputActionPerformed
    ...
    private void confirmButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButton3ActionPerformed
        ProductPanel productsPanel = (ProductPanel) container3.getComponent(0);
         String selectedProduct = productsPanel.getSelectedProduct();
    ...
    try {
        ...
        if(inputAmount >= 0){
            ...
            JOptionPane.showMessageDialog(this, "Invalid price. Please enter a valid quantity.", "Invalid Price", JOptionPane.ERROR_MESSAGE);           
        }

    } catch (NumberFormatException e) {
        // Handle invalid input (e.g., non-numeric input) here if needed
    ...
    private void performRestock(String selectedProduct, int inputAmount){
    int slotIndex = -1;
    ...
    try {
        ...
        private void performEditPrice(String selectedProduct, int inputAmount){
    int slotIndex = -1;
        for (int i = 0; i < machine.getSlotList().size(); i++) {
            Slot slot = machine.getSlotList().get(i);
            if (slot.getProduct().getName().equals(selectedProduct)) {
    ...
    try {
        ...
        editPriceInput.setText("");
            ...
            JOptionPane.showMessageDialog(this, "Invalid input. Please enter an integer.", "Invalid Price", JOptionPane.ERROR_MESSAGE);
    }
    }
...
private void initializePrintProductPanel(Machine machine) {
    if (printProductPanel != null) {
        container4.removeAll();
    }
    
    printProductPanel = new PrintProductPanel(machine);
