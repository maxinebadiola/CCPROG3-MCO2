...
public class PaymentPanel extends javax.swing.JPanel {
    ...
    public PaymentPanel(Machine machine) {
        this.machine = machine;
        this.currencyPanel = new CurrencyPanel(machine); 
        initComponents();
        initializeCurrencyPanel(machine); // Call the method to initialize ProductsPanel with the existing Machine
    }
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Enter Payment");
        ...
        confirmPaymentButton.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 255), 5, true));
    ...
    try {
        ...
        if (machine.validPayments(selectedCurrencies)) {
            throw new Exception("Please enter a valid count for at least one currency.");
        }

        machine.updateCurrencyStockWithPayment(selectedCurrencies);
        totalPayment = machine.calculateTotalPayment(selectedCurrencies);

        mainJFrame frame = (mainJFrame) javax.swing.SwingUtilities.getWindowAncestor(this);
 
        TransactionPanel transactionPanel = new TransactionPanel(machine, totalPayment);

        javax.swing.JLayeredPane jLayeredPane1 = frame.getjLayeredPane1();
        jLayeredPane1.add(transactionPanel, "transactionPanel");

        CardLayout cardLayout = (CardLayout) jLayeredPane1.getLayout();
        cardLayout.show(jLayeredPane1, "transactionPanel");
        ...
        jPanel1.add(currencyPanel, BorderLayout.CENTER); // Add the ProductsPanel to RVMPanel
    }
